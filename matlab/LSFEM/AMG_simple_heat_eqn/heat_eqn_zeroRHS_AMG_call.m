% ****************************************************************** %
% ************ SOLVING LSFEM HEAT EQN WITH F = 0 USING ************* %
% ****************** ALGEBRRAIC *** MULTIGRID ********************** %
% ****************************************************************** %
...
%sol_mg = GaussSeidelSolve_LS(Hess_J_sym, rhs_sym, sol_bdy, max_iter);

sol_mg = two_level_AMG(Hess_J_sym, rhs_sym, sol_bdy, smoother, eps, max_iter);
