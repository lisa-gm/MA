...
% TRUST REGION STEP
[sigma, u, norm_grad_J, ~, TR_rad] = TR_step(TR_rad, TR_rad_max, eta, max_iter_TR, S, Nx_elem, T, Nt_elem, u0, bdy_cond, bdy_left, bdy_right, sigma, u, update, grad_J, Hess_J, J_ss_lin, J_su_lin, J_us_lin, J_uu_lin, c1, c2, diff_const, iter);
 TR_rad
    if(norm_grad_J < eps)
        fprintf('convergence criterion reached after %d iterations\n', iter);
        break;
