...
function [sol, it_sol_mg, it_res_mg] = V_cycle_galerkin_assembly(Nx_elem_list, hx_list, Nt_elem_list, ht_list, Hess_J, f, sol_init, bdy_cond, u0, bdy_left, bdy_right, levels, max_iter, smoother, eps)
